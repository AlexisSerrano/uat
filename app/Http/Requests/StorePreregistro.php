...
class StorePreregistro extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'numExterno1.max' => 'El Número Externo no debe contener mas de 10 caracteres.',
            'numInterno1.min' => 'El Número interno debe contener al menos un caracter.',
            'numInterno1.max' => 'El Número interno no debe contener mas de 10 caracteres.',
            ...
            'numDocIdentificacion.max' => 'El Número de identificación no debe contener mas de 50 caracteres.',
            ...
            'numExterno2.max' => 'El Número externo no debe contener mas de 10 caracteres.',
            'numInterno2.min' => 'El Número interno debe contener al menos un caracter.',
            'numInterno2.max' => 'El Número interno no debe contener mas de 10 caracteres.',
