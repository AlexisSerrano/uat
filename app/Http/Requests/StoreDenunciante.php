...
class StoreDenunciante extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'narracion.min'=> 'El campo Descripción de hechos debe como mínimo 5 caracteres',
            'narracion.max'=> 'El campo Descripción de hechos debe como máximo 2000 caracteres',
        ];
    }
}
