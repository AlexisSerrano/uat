...
return view('fields.resumen-carpeta.datos-carpeta')->with('carpeta',$carpeta);
    ...
    public function detalleDenunciado(){
        ...
        if(is_null($idCarpeta)){
            ...
            //persona fisica
            ->leftJoin('componentes.variables_persona_fisica as variables_fisica', 'variables_fisica.id', '=', 'apariciones.idVarPersona')
            ->leftJoin('componentes.extra_denunciado_fisico as extra_fisica', 'extra_fisica.idVariablesPersona', '=', 'variables_fisica.id')
            ->leftJoin('componentes.persona_fisica as persona_fisica', 'variables_fisica.idPersona', '=', 'persona_fisica.id')
            ->leftJoin('componentes.cat_etnia as etnia', 'persona_fisica.idEtnia', '=', 'etnia.id')
            ->leftJoin('componentes.sexos as sexo', 'persona_fisica.sexo', '=', 'sexo.id')
            ->leftJoin('componentes.cat_nacionalidad as nacionalidad', 'persona_fisica.idNacionalidad', '=', 'nacionalidad.id')
            ...
            ->leftJoin('componentes.variables_persona_moral as variables_moral', 'variables_moral.id', '=', 'apariciones.idVarPersona')
            ->leftJoin('componentes.persona_moral as persona_moral', 'persona_moral.id', '=', 'variables_moral.idPersona')
            ->leftJoin('componentes.extra_denunciado_moral as extra_moral', 'extra_moral.idVariablesPersona', '=', 'variables_moral.id')
            ->leftJoin('componentes.cat_identificacion as identificacion_moral', 'variables_moral.docIdentificacion', '=', 'identificacion_moral.id')
            ...
            ->select(       
                ...
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.id ELSE extra_moral.id END) AS denunciadoid'),//'extra_denunciado.id as denunciadoid',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN variables_fisica.idNotificacion ELSE variables_moral.idNotificacion END) AS denunciadoidNotificacion'),//'extra_denunciado.idNotificacion as denunciadoidNotificacion',
                // DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.idAbogado ELSE extra_moral.idAbogado END) AS denunciadoidAbogado'),//'extra_denunciado.idAbogado as denunciadoidAbogado',
                // DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.resguardarIdentidad ELSE extra_moral.resguardarIdentidad END) AS denunciadoreguardarIdentidad'),//'extra_denunciado.reguardarIdentidad as denunciadoreguardarIdentidad',
                // DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.victima ELSE extra_moral.victima END) AS denunciadovictima'),//'extra_denunciado.victima as denunciadovictima',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN "PENDIENTE POR HACER" ELSE "PENDIENTE POR HACER" END) AS denunciadonarracion'),//'extra_denunciante.narracion as denunciantenarracion',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.alias ELSE extra_moral.alias END) AS denunciadoalias'),//'extra_denunciado.alias as denunciadoalias',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.senasPartic ELSE extra_moral.senasPartic END) AS denunciadosenasPartic'),//'extra_denunciado.senasPartic as denunciadosenasPartic',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.ingreso ELSE extra_moral.ingreso END) AS denunciadoingreso'),//'extra_denunciado.ingreso as denunciadoingreso',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.periodoIngreso ELSE extra_moral.periodoIngreso END) AS denunciadoperiodoIngreso'),//'extra_denunciado.periodoIngreso as denunciadoperiodoIngreso',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.residenciaAnterior ELSE extra_moral.residenciaAnterior END) AS denunciadoresidenciaAnterior'),//'extra_denunciado.residenciaAnterior as denunciadoresidenciaAnterior',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.idAbogado ELSE extra_moral.idAbogado END) AS denunciadoidAbogado'),//'extra_denunciado.idAbogado as denunciadoidAbogado',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN extra_fisica.vestimenta ELSE extra_moral.vestimenta END) AS denunciadovestimenta'),//'extra_denunciado.vestimenta as denunciadovestimenta',
                ...
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN colonia_df.nombre ELSE colonia_dm.nombre END) AS domicilioColonia'),//'cat_colonia.nombre as domicilioColonia',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN colonia_df.codigoPostal ELSE colonia_dm.codigoPostal END) AS domicilioCp'),//'cat_colonia.codigoPostal as domicilioCp',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN ifnull(domicilio_fisica.calle,"SIN INFORMACION") ELSE ifnull(domicilio_moral.calle,"SIN INFORMACION") END) AS domicilioCalle'),//'domicilio.calle as domicilioCalle',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN ifnull(domicilio_fisica.numExterno,"S/N") ELSE ifnull(domicilio_moral.numExterno,"S/N") END) AS domicilioNumExterno'),//'domicilio.numExterno as domicilioNumExterno',
                DB::raw('(CASE WHEN apariciones.esEmpresa = 0 THEN domicilio_fisica.numInterno ELSE domicilio_moral.numInterno END) AS domicilioNumInterno'),//'domicilio.numInterno as domicilioNumInterno',
