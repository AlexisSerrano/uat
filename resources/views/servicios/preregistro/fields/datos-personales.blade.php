<div class="row">
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('nombre2', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el nombre','data-validation'=>'custom' , 'data-validation-regexp'=>'^([A-Z]+)$' ,'required']) !!}
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('primerAp', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el primer apellido','data-validation'=>'custom' , 'data-validation-regexp'=>'^([A-Z]+)$','required']) !!}
			<div class="help-block with-errors"></div>
		</div>
	</div>
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('segundoAp', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el segundo apellido','data-validation'=>'custom' , 'data-validation-regexp'=>'^([A-Z]+)$','required']) !!}
		</div>
	</div>
	<div class="col-4">
			<div class="form-group">
