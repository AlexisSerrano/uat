	...
	<div class="row">
		...
		<div class="col-2">
			<div class="form-group">
				...
				{!! Form::text('numInterno', null, ['class' => 'dom form-control form-control-sm', 'placeholder' => 'Ingrese el número interior', 'data-validation'=>'custom','data-validation-optional'=>'true']) !!}
			</div>
		</div>
	</div>
