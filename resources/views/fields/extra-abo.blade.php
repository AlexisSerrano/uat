<div class="row">
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::text('cedulaProf', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese la cédula profesional', 'data-validation'=>'length', 'data-validation-length'=>'min8']) !!}
		</div>
	</div>
	<div class="col-3">
		<div class="form-group">
