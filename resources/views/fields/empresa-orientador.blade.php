<div class="row" >
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('nombre1', $preregistro->nombre, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el nombre','data-validation'=>'required','data-validation-ignore'=>'.']) !!}
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::number('telefono1', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el teléfono', 'data-validation'=>'custom','data-validation-optional'=>'true', 'data-validation-regexp'=>'^([0-9]{10,15}|(SIN NUMERO)|(SN))$']) !!}
			<div class="help-block with-errors"></div>
		</div>
	</div>
	<div class="col-4">
	...
	<div class="col-2">
		<div class="form-group">
			...
			{!! Form::text('numExterno1', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el núm. Ext.', 'data-validation'=>'required']) !!}
		</div>
	</div>
	<div class="col-2">
		<div class="form-group">
			{!! Form::label('numInterno1', 'Número interior', ['class' => 'col-form-label-sm']) !!}
			{!! Form::text('numInterno1', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el núm. Int.','data-validation'=>'custom','data-validation-optional'=>'true']) !!}
		</div>
	</div>
	<div class="col-4">
		<div class="form-group">
