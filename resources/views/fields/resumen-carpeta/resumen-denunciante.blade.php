...
<div class="card-header">
    ...
    <div class="card-body" id="perdonaFisica">
        <div class="row">
                            ...
                            <div class="col-2">
                                ...
                                <div class="col-12" style="text-align:center">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="col-12" style="text-align:center">
                                                    <p><h5 class="detalle">Datos del denunciante</p></h5></div>
                    <div class="col-4">
                        <div class="form-group">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                {!! Form::label('victima', null, ['class' => 'col-form-label-sm']) !!}
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
    ...
    <div class="card-body" id="personaMoral">
        <div class="row">
                <div class="row">
                        <div class="col-8">
                            <div class="form-group">
