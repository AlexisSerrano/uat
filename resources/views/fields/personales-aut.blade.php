<div class="row">
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::text('motivoEstancia', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el motivo de estancia','data-validation-optional'=>'true']) !!}
		</div>
	</div>
	<div class="col-3">
		<div class="form-group">
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::text('docIdentificacion', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el docto. de identificacion','data-validation-optional'=>'true']) !!}
		</div>
	</div>
	<div class="col-3">
		<div class="form-group">
