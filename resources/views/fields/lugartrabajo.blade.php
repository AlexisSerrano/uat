<div class="row">
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::number('telefonoTrabajo', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el teléfono del trabajo','data-validation'=>'custom', 'data-validation-regexp'=>'^([0-9]{10,15}|(SIN NUMERO)|(SN))$']) !!}
		</div>
	</div>
</div>
