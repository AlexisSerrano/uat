    ...
    <div id="accordion">
            ...
            <div class="card">
                <div class="card-header" id="headingOne">
                    <h5 class="mb-0"><a class="btn " style="color:black;" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            Formatos basicos</a>
                    </h5>
                </div>
                    ...
                    <table class="table table-hover"  >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['caratulaC']}}</span></td>                              
                                <td style="text-align:center;"><a href="{{ route("caratula",session('carpeta'))}}" title="imprimir" class=" hola btn-lg btn-secondary" TARGET=”_blank”><i class="fa fa-print"></i></a></td> 
                            </tr>
                            <tr>
                                <td>Formato de denuncia/querella </td>
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['querella']}}</span></td>
                                <td style="text-align:center;"><a href="{{ route("formato.denuncia",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg " TARGET=”_blank”><i class="fa fa-print"></i></a>
                                </td> 
                            </tr>  
                            <tr>
                                <td style="text-align:left;">Acuerdo de inicio</td>
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['acuerdoInicioc']}}</span></td>
                                <td style="text-align:center;"><a href="{{ route("impresion.acuerdoInicio",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg " TARGET=”_blank”><i class="fa fa-print"></i></a>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-header" id="headingfive">
                    <h5 class="mb-0"><a class="btn collapsed" style="color:black;" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                            Estatus de la carpeta</a>
                    </h5>
                </div>
                    ...
                    <table class="table table-hover"  >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['actuacionesC']}}</span></td>
                                <td style="text-align:center;"><a href="{{ route("not.actuaciones",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg" TARGET=”_blank”><i class="fa fa-print"></i></a>
                                </td> 
                            </tr> 
                            <tr>
                                <td>Remisión fiscal de distrito</td>
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['acuerdoRemisionC']}}</span></td>
                                <td style="text-align:center;"><a href="{{ route("fiscal.distrito",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg " ><i class="fa fa-print"></i></a>
                                </td> 
                            </tr> 
                            <tr>
                                <td>Notificación de archivo temporal</td>
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['temporalC']}}</span></td> 
                                <td style="text-align:center;"><a href="{{ route("impresion.temporal",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg" TARGET=”_blank”><i class="fa fa-print"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>Acuerdo de remisión </td>
                                <td style="text-align:center;"><span class="badge badge-info right">{{$data['remicionC']}}</span></td>
                                <td style="text-align:center;"><a href="{{ route("oficio.remision",session('carpeta'))}}" title="imprimir"  class=" btn-secondary btn-lg " TARGET=”_blank”><i class="fa fa-print"></i></a>
                                </td> 
                            </tr>  
                        </tbody>
                    </table>
